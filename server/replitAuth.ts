...
export function getSession() {
  ...
  try {
    ...
    console.log('✅ PostgreSQL session store configurado');
    ...
    console.log('⚠️ Erro ao conectar PostgreSQL para sessions:', error);
    console.log('🔄 Usando MemoryStore (sessions temporárias)');
