...
- **Chat funcionando no Vercel sem WebSocket** (25/06/2025): Reconexão infinita corrigida, envio de mensagens funcionando, embeds enviando corretamente, polling em vez de WebSocket no Vercel
